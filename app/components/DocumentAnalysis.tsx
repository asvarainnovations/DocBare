...
const analysisTypes: {
...
}[] = [
  {
    ...
    description:
      "Comprehensive overview of the document structure and key points",
...
export default function DocumentAnalysis({
  ...
  const [results, setResults] = useState<
    Record<AnalysisType, AnalysisResult | null>
  >({
    summary: null,
    clauses: null,
    risks: null,
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div>
            ...
            <p
              id="document-analysis-description"
                          ...
                          <div className="p-4">
                                ...
                                <div className="prose prose-invert max-w-none">
                                  <ReactMarkdown
                                    components={{
                                      ...
                                      p: ({ children }) => (
                                        <p className="text-white mb-3 leading-relaxed last:mb-0">
                                          {children}
                                        </p>
                                      ),
                                      ul: ({ children }) => (
                                        <ul className="text-white mb-4 space-y-1 list-disc list-inside">
                                          {children}
                                        </ul>
                                      ),
                                      ol: ({ children }) => (
                                        <ol className="text-white mb-4 space-y-1 list-decimal list-inside">
                                          {children}
                                        </ol>
                                      ),
                                      li: ({ children }) => (
                                      ...
                                      blockquote: ({ children }) => (
                                        <blockquote className="border-l-4 border-accent pl-4 italic text-gray-300 mb-4">
                                          {children}
                                        </blockquote>
                                      ),
                                      strong: ({ children }) => (
                            ...
                            {!isLoading && !error && !result && (
                              <div className="text-center py-8 text-gray-400">
                                ...
                                <p>
                                  Click &quot;Analyze All&quot; or select this
                                  analysis type to begin
                                </p>
                              </div>
                            )}
                          </div>
