  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background">
      <div className="w-full max-w-md mx-auto p-8 rounded-lg shadow-lg bg-card border border-border">
        <h1 className="text-3xl font-bold mb-8 text-center text-foreground">Welcome back</h1>
        ...
        {providerErrorMsg && <div className="text-destructive text-center mt-2">{providerErrorMsg}</div>}
