    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      <div className="w-full max-w-md mx-auto p-8">
        ...
        <button
          ...
          className="w-full flex text-black items-center justify-center gap-2 border border-gray-300 py-3 rounded text-lg font-medium bg-white hover:bg-gray-100 transition"
        >
